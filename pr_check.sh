...
export IMAGE="quay.io/cloudservices/host-inventory-subgraph"
...
# --------------------------------------------
COMPONENT_NAME="host-inventory-subgraph"  # name of app-sre "resourceTemplate" in deploy.yaml for this component
